...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Dev\Integracion-evaluacion-3\env-evaluacion3'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Dev\Integracion-evaluacion-3\env-evaluacion3\Scripts\deactivate.nu'
